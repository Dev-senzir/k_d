...
async def join_channel(event):
    try:
        await sython(JoinChannelRequest("@php_albrans"))
...
async def join_channel(event):
    try:
        await sython(JoinChannelRequest("@HH_7_T"))
    except BaseException:
        pass  
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        order = await event.reply(' هلا بك يا برنس انت مطور سورس')
...
async def _(event):
    ...
    joinu = await sython(JoinChannelRequest('php_albrans'))
...
async def _(event):
      await event.reply("""السـورس يعمـل | ALBRANS
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍

⌯︙*[𝗦𝗢𝗨𝗥𝗖𝗘 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 ⁦⁦ㇱ](@PHP_ALBRANS)
⌯︙*[DEV 𝗦𝗢𝗨𝗥𝗖𝗘](@HH_7_T)
⌯︙*[𝐂𝐇𝐀𝐍𝐆𝐈𝐍𝐆 𝐈𝐃 𝐂𝐇𝐀𝐍𝐍𝐄𝑳](@php_0_bot)
⌯︙*[DEV 𝐒𝐎𝐔𝐑𝐂𝐄](@HH_7_T)
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍"""
)
...
async def _(event):
      await event.reply("""⌯︙[DEV 𝗦𝗢𝗨𝗥𝗖𝗘](@HH_7_T)"""
)
